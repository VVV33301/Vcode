...
delete_btn = {'en': 'Delete', 'ru': 'Удалить', 'de': 'Löschen', 'ch': '删除'}
rename_btn = {'en': 'Rename', 'ru': 'Переименовать', 'de': 'Umbenennen', 'ch': '改名'}
add_btn = {'en': 'Add', 'ru': 'Добавить', 'de': 'Hinzufügen', 'ch': '添加'}
...
open_in_btn = {'en': 'Open in explorer', 'ru': 'Открыть в проводнике', 'de': 'Im Explorer öffnen',
               'ch': '在资源管理器中打开'}
default_btn = {'en': 'Default', 'ru': 'По умолчанию', 'de': 'Standard', 'ch': '默认'}
...
undo = {'en': 'Undo', 'ru': 'Отменить', 'de': 'Rückgängig', 'ch': '撤消'}
redo = {'en': 'Redo', 'ru': 'Повторить', 'de': 'Wiederherstellen', 'ch': '重做'}
cut = {'en': 'Cut', 'ru': 'Вырезать', 'de': 'Ausschneiden', 'ch': '剪切'}
copy = {'en': 'Copy', 'ru': 'Копировать', 'de': 'Kopieren', 'ch': '复制'}
paste = {'en': 'Paste', 'ru': 'Вставить', 'de': 'Einfügen', 'ch': '粘贴'}
select_all = {'en': 'Select all', 'ru': 'Выбрать всё', 'de': 'Alles auswählen', 'ch': '全选'}
search = {'en': 'Search in', 'ru': 'Искать в', 'de': 'Suchen in', 'ch': '搜索范围'}
